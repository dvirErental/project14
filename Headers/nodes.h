...
node *existNode(char *name, node* otherFirst);/*Searches for a node in a linked list. return the node of the macro if it was found and NULL if didn't*/

void add_to_list (char *name, char *content, int line_num, char*); /*Adds a node to the linked list.*/
